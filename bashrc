...
#http://collectiveidea.com/blog/archives/2011/08/02/command-line-feedback-from-rvm-and-git/?utm_source=feedburner&utm_medium=feed&utm_campaign=Feed%3A+collectiveidea+%28Collective+Idea+Blog%29
...
export CDPATH=.:~:~/work/p10labs:~/projects:~/work:~/foss:~/foss-contrib #does for the cd built-in what PATH does for executables. 
